...
First of all, Comics is just a [Django](https://www.djangoproject.com/)
...
- Download the lastest release from
  <https://github.com/jodal/comics/releases>.
...
- Clone the Git repository. You can do so by running:
    ...
    Git repository. If you checkout a tag name, you'll have exactly the same
    as you find in the release archives:
...
The simple way is to install [uv](https://docs.astral.sh/uv/), and while in
...
If you're setting up Comics for development, you should install
[uv](https://docs.astral.sh/uv/), and in the Comics git repository, run:
