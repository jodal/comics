...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserSet.last_loaded'
        db.delete_column('comics_userset', 'last_loaded')

        # Deleting field 'UserSet.last_modified'
        db.delete_column('comics_userset', 'last_modified')


    def backwards(self, orm):
        # Adding field 'UserSet.last_loaded'
        db.add_column('comics_userset', 'last_loaded', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)

        # Adding field 'UserSet.last_modified'
        db.add_column('comics_userset', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)
